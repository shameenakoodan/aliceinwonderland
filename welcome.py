...
class AliceInWonderLand:
    ...
    def fall(self):
        ...
        while followorexplore not in follow_explore:
            followortexplore = input("Would you like to follow or explore? follow/explore")
    ...
    def somewhere(self):
        ...
        gardenorbushes = ''
        while gardenorbushes not in garden_bushes:
            gardenorbushes= input("Would you like to go through garden or that way? garden/bushes")
